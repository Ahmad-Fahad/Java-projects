...
public class Age_Calculator extends JFrame{
	...
	public void go(){
		...
		for(int i=0;i<com.length;i++){
			...
			c1.setFont(new Font("ALGERIAN",Font.BOLD,25));
			c2.setFont(new Font("ALGERIAN",Font.BOLD,25));
			pc.add(c1);
			pb.add(c2);
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Age_Calculator key=new Age_Calculator();
		key.go();
